...
// You should use for..in in your code, otherwise your solution may not pass.At

Solution:
giveMeFive = obj => /*for( in )*/[].concat(...Object.entries(obj)).filter(element => element.length == 5)